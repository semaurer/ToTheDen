	...
	class Game {
	  ...
	  createMovingObjects() {
	    ...
	    for (let i = 0; i < 4; i++) {
	      ...
	      movingObjects.push(new MovingObject(firstRowXPos, 282, 1, true, "left", "tanCat"));
	      movingObjects.push(new MovingObject(thirdRowXPos, 242, 0.8, true, "left", "tanCat"));
	      firstRowXPos += 140;
	      thirdRowXPos += 140;
	    }
	    ...
	    for (let i = 0; i < 3; i++) {
	      movingObjects.push(new MovingObject(seventhRowXPos, 88, 0.8, false, "left", "tanCat"));
	      movingObjects.push(new MovingObject(seventhRowXPos, 166, 1, false, "left", "tanCat"));
	      seventhRowXPos += 160;
	    }
	    ...
	    for (let i = 0; i < 2; i++) {
	      movingObjects.push(new MovingObject(fourthRowXPos, 202, 1.3, true, "right", "tanCat"));
	      movingObjects.push(new MovingObject(eigthRowXPos, 48, 1.3, false, "right", "tanCat"));
	      movingObjects.push(new MovingObject(fourthRowXPos, 128, 2.2, false, "right", "tanCat"));
	      eigthRowXPos -= 300;
	      fourthRowXPos += 200;
	    }
	  ...
	  handleKeyPress(e) {
	    if (e.keyCode === 13) this.resetGame();
...
/***/ function(module, exports, __webpack_require__) {
	...
	const explosionAnimations = __webpack_require__(8);
