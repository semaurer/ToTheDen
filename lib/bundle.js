...
/***/ function(module, exports, __webpack_require__) {
	...
	class Game {
	  ...
	  createMovingObjects() {
	    ...
	    for (let i = 0; i < 4; i++) {
	      movingObjects.push(new MovingObject(firstRowXPos, 322, 0.7, true, "right", "tanCat"));
	      movingObjects.push(new MovingObject(firstRowXPos, 282, 0.7, true, "left", "blueCat"));
	      movingObjects.push(new MovingObject(thirdRowXPos, 242, 0.5, true, "left", "chestnutDog"));
	      movingObjects.push(new MovingObject(fourthRowXPos, 202, 1, true, "right", "greyCat"));
	      firstRowXPos += 140;
	      thirdRowXPos += 140;
	      fourthRowXPos += 150;
	    }
	    ...
	    for (let i = 0; i < 3; i++) {
	      movingObjects.push(new MovingObject(fifthRowXPos, 88, 0.6, false, "left", "log2"));
	      movingObjects.push(new MovingObject(seventhRowXPos, 166, 0.7, false, "left", "log2"));
	      fifthRowXPos += 160;
	      seventhRowXPos += 160;
	    }
	    ...
	    for (let i = 0; i < 2; i++) {
	      movingObjects.push(new MovingObject(eigthRowXPos, 48, 1, false, "right", "log1"));
	      movingObjects.push(new MovingObject(sixthRowXPos, 128, 1.9, false, "right", "log1"));
	      sixthRowXPos += 200;
	      eigthRowXPos -= 300;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	const spikeAnimation = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const animalAnimations = __webpack_require__(9);
