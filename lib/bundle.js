...
/***/ function(module, exports, __webpack_require__) {
	...
	const caveAnimations = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	class MovingObject {
	  ...
	  draw(ctx) {
	    ...
	    if (this.speed <= 1) {
	      if (this.enemy === true) {
	        // ctx.strokeRect(this.xPos, this.yPos, 23, 30);
	        this.width = 23;
	        this.height = 30;
	      } else {
	        // ctx.strokeRect(this.xPos, this.yPos, 80, 20);
	        this.width = 80;
	        this.height = 20;
	      }
	    } else {
	      if (this.enemy === true) {
	        ...
	        // ctx.strokeRect(this.xPos, this.yPos, 112, 20);
	        this.width = 112;
	        this.height = 20;
	      }
	    }
